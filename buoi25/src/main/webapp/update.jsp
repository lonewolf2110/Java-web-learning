...
<div class="container">
    <form method="post" action="update">
        <div class="form-group" hidden>
            ...
            <input type="text" class="form-control" id="id" name="id" value="${student.getId()}" required />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="class" name="class" placeholder="Nhập tên lớp"
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="score" name="score" step="0.01" placeholder="Nhập điểm trung bình"
                   value="${student.getScore()}" required />
        </div>
